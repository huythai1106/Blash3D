Shader "TCP2 Hybrid Shader_LargeCube" {
	Properties {
		...
		[HideInInspector] _BaseColorShiftBlend ("Base Color Shift Blend", Range(0, 1)) = 0
		[HideInInspector] _BaseColorShiftSaturation ("Base Color Shift Saturation", Range(0, 2)) = 1
		[HideInInspector] _BaseColorShiftValue ("Base Color Shift Value", Range(0, 2)) = 1
		[HideInInspector] [NoScaleOffset] _BaseColorShiftNoiseTex ("Base Color Shift Noise", 2D) = "gray" {}
		[HideInInspector] _BaseColorShiftMappingMode ("Base Color Shift Mapping Mode", Float) = 0
		[HideInInspector] _BaseColorShiftNoiseScale ("Base Color Shift Noise Scale", Float) = 1
		[HideInInspector] _BaseColorShiftNoiseScaleXYZ ("Base Color Shift Noise Scale XYZ", Vector) = (1,1,1,0)
		[HideInInspector] _BaseColorShiftUseSecondaryMask ("Use Secondary Mask", Float) = 0
		[HideInInspector] [NoScaleOffset] _BaseColorShiftSecondaryMaskTex ("Base Color Shift Secondary Mask", 2D) = "white" {}
		[HideInInspector] _BaseColorShiftSecondaryMaskScale ("Base Color Shift Secondary Mask Scale", Float) = 1
		[HideInInspector] _BaseColorShiftSecondaryMaskScaleXYZ ("Base Color Shift Secondary Mask Scale XYZ", Vector) = (1,1,1,0)
		[HideInInspector] _BaseColorShiftSoftness ("Base Color Shift Softness", Range(0.001, 0.5)) = 0.05
		[HideInInspector] _BaseColorShiftUseScaleCompensation ("Use Scale Compensation", Float) = 0
		[HideInInspector] _BaseColorShiftUseEmissionBand ("Use Emission Band", Float) = 0
		[HideInInspector] [HDR] _BaseColorShiftEmissionBandColor ("Base Color Shift Emission Band Color", Vector) = (1,0.5,0.1,1)
		[HideInInspector] _BaseColorShiftEmissionBandIntensity ("Base Color Shift Emission Band Intensity", Range(0, 5)) = 1
		[HideInInspector] _BaseColorShiftEmissionBandWidth ("Base Color Shift Emission Band Width", Range(0.001, 0.5)) = 0.05
	...
	//CustomEditor "CubeBlast.Editor.TCP2LargeCubeShaderGUI"
}