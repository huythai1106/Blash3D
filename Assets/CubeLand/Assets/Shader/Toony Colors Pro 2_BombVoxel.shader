Shader "Toony Colors Pro 2/BombVoxel" {
	Properties {
		...
		[TCP2ColorNoAlpha] _Color2 ("Color 2", Vector) = (1,1,1,1)
		_Color2Fill ("Color 2 Fill", Range(0, 1)) = 0
		[TCP2ColorNoAlpha] _HighlightColor ("Highlight Color", Vector) = (1,1,1,1)
