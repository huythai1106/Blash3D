Shader "Toony Colors Pro 2/ShrinkingCover" {
	Properties {
		...
		[TCP2ColorNoAlpha] _ShrinkingCoverColorA ("Stripe Color A", Vector) = (0.12,0.95,1,1)
		[TCP2ColorNoAlpha] _ShrinkingCoverColorB ("Stripe Color B", Vector) = (1,1,1,1)
		_ShrinkingCoverStripeScale ("Stripe Scale", Range(0.05, 20)) = 4
		_ShrinkingCoverStripeOffset ("Stripe Offset", Float) = 0
		[Enum(World X,0,World Y,1,World Z,2)] _ShrinkingCoverStripeAxis ("Stripe Axis", Float) = 1
