Shader "Toony Colors Pro 2/MeteorShower" {
	Properties {
		...
		[TCP2ToggleNoKeyword] _UseCrackTexture ("Crack Texture (UV2)", Float) = 1
		_CrackMap ("Texture", 2D) = "black" {}
		[TCP2ColorNoAlpha] _CrackColor ("Crack Color", Vector) = (0,0,0,1)
		_CrackIntensity ("Crack Intensity", Range(0, 1)) = 0
		_CrackSize ("Crack Size", Range(0.1, 10)) = 1
		_CrackSoftness ("Crack Softness", Range(0, 1)) = 0
		[Normal] _CrackNormalMap ("Crack Normal Map (UV2)", 2D) = "bump" {}
		_CrackNormalStrength ("Crack Normal Strength", Range(0, 1)) = 0
