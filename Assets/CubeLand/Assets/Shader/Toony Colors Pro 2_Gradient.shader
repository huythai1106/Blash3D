Shader "Toony Colors Pro 2/Gradient" {
	Properties {
		...
		_GradientAlphaStart ("Gradient Alpha Start", Range(0, 1)) = 0
		_GradientAlphaEnd ("Gradient Alpha End", Range(0, 1)) = 1
		_GradientAlphaSoftness ("Gradient Alpha Softness", Range(0, 1)) = 1
		_GradientAlphaStrength ("Gradient Alpha Strength", Range(0, 1)) = 1
		[HDR] _GradientBloomColor ("Gradient Bloom Color", Vector) = (1,1,1,1)
		_GradientBloomIntensity ("Gradient Bloom Intensity", Range(0, 10)) = 0
		_GradientBloomAlphaMask ("Gradient Bloom Alpha Mask", Range(0, 1)) = 1
