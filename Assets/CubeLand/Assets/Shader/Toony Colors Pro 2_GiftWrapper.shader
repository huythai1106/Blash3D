Shader "Toony Colors Pro 2/GiftWrapper" {
	Properties {
		...
		_GiftStarsMap ("Stars Texture", 2D) = "black" {}
		_GiftStarsOpacity ("Stars Opacity", Range(0, 1)) = 0
		_GiftStarsCutProgress ("Stars Cut Progress", Range(0, 1)) = 0
		_GiftStarsBrightness ("Stars Brightness", Range(0, 2)) = 1
		_GiftStarsContrast ("Stars Contrast", Range(0, 2)) = 1
		_GiftStarsCutSoftness ("Stars Cut Softness", Range(0.001, 0.5)) = 0.01
		_GiftStarsCutOrderMap ("Stars Cut Order", 2D) = "white" {}
		_GiftStarsCutOrderSRGBCorrection ("Stars Cut Order sRGB Fix", Range(0, 1)) = 1
		_GiftStarsCutNoiseScale ("Stars Cut Noise Scale", Range(1, 80)) = 18
		_GiftStarsCutNoiseContrast ("Stars Cut Noise Contrast", Range(0.25, 4)) = 1
		_GiftStarsCutNoiseSeed ("Stars Cut Noise Seed", Range(0, 100)) = 0
		_GiftStarsCutNoiseSteps ("Stars Cut Noise Steps", Range(1, 32)) = 1
		_GiftStarsCutDuration ("Stars Cut Duration", Range(0.01, 1)) = 0.25
		_GiftWrapperSharedTiling ("Shared Tiling", Float) = 1
