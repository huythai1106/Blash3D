Shader "Toony Colors Pro 2/VacuumBooster" {
	Properties {
		...
		_VacuumBulgeProgress ("Vacuum Bulge Progress", Range(0, 1)) = 0
		_VacuumBulgeAmount ("Vacuum Bulge Amount", Float) = 0.08
		_VacuumBulgeProgress2 ("Vacuum Bulge Progress 2", Range(0, 1)) = 0
		_VacuumBulgeAmount2 ("Vacuum Bulge Amount 2", Float) = 0
		_VacuumBulgeProgress3 ("Vacuum Bulge Progress 3", Range(0, 1)) = 0
		_VacuumBulgeAmount3 ("Vacuum Bulge Amount 3", Float) = 0
		_VacuumBulgeWidth ("Vacuum Bulge Width", Range(0.001, 1)) = 0.15
		_VacuumBulgeStart ("Vacuum Bulge Start", Float) = -0.2
		_VacuumBulgeEnd ("Vacuum Bulge End", Float) = 1.2
		[Enum(U,0,V,1)] _VacuumBulgeUVAxis ("Vacuum Bulge UV Axis", Float) = 0
