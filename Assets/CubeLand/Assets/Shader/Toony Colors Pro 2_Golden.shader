Shader "Toony Colors Pro 2/Golden" {
	Properties {
		...
		[Enum(UV1,0,UV2,1,UV3,2,UV4,3)] _MainUVSet ("Texture UV Set", Float) = 1
		...
		[Toggle(TCP2_GOLD_GRAIN)] _UseGoldGrain ("Enable Grain", Float) = 0
		_GoldGrainTex ("Grain Texture", 2D) = "gray" {}
		_GoldGrainScale ("Grain Scale", Range(0.05, 80)) = 24
		_GoldGrainIntensity ("Grain Intensity", Range(0, 2)) = 0
		[Toggle(TCP2_GOLD_DARK_PATCHES)] _UseGoldDarkPatches ("Enable Dark Patches", Float) = 0
		_GoldDarkPatchTex ("Dark Patch Texture", 2D) = "gray" {}
		_GoldDarkPatchScale ("Dark Patch Scale", Range(0.05, 20)) = 1.35
		_GoldDarkPatchIntensity ("Dark Patch Intensity", Range(0, 1)) = 0.18
		_GoldDarkPatchSoftness ("Dark Patch Softness", Range(0.01, 1)) = 0.45
		_GoldDarkPatchThreshold ("Dark Patch Threshold", Range(0, 1)) = 0.56
		[TCP2ColorNoAlpha] _GoldDarkPatchColor ("Dark Patch Color", Vector) = (0.58,0.37,0.08,1)
		[Toggle(TCP2_GOLD_BODY_DEPTH)] _UseGoldBodyDepth ("Enable Body Depth", Float) = 0
		_GoldBodyDepthIntensity ("Body Depth", Range(0, 1)) = 0
		_GoldBodyDepthCenter ("Body Depth Center", Range(0, 1)) = 0.308
		_GoldBodyDepthWidth ("Body Depth Width", Range(0.05, 1)) = 0.896
		_GoldBodyDepthSideShade ("Body Side Shade", Range(0, 1)) = 0.553
		_GoldBodyDepthHighlight ("Body Center Highlight", Range(0, 1)) = 0.451
		[TCP2ColorNoAlpha] _GoldBodyDepthShadowColor ("Body Shadow Color", Vector) = (0.55,0.35,0.04,1)
		[TCP2ColorNoAlpha] [HDR] _GoldBodyDepthHighlightColor ("Body Highlight Color", Vector) = (1.35,0.95,0.24,1)
